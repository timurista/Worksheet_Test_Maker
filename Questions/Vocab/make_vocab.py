		...
		if s:
			try:
				...
				if sent:
					...
					csv+="Vocabulary\tIdentify the synonym for the underlined <u>word</u>.\t"+new_sent.sub(syn_word, sent)+"\t"+answers[0]+"\t"+answers[1]+"\t"+answers[2]+"\t"+answers[3]+"\t"+answers[4]+"\n"
					#print csv
...
#print get_synonym_words("bewilder")
